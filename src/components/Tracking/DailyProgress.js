...
const DailyProgress = () => {
  ...
  return (
    <TouchableOpacity style={styles.card} activeOpacity={0.7} onPress={() => navigation.navigate('DailyLog')}>
      ...
      <AppText variant="small" color={Colors.tealDark} style={styles.cta}>View Details ›</AppText>
    </TouchableOpacity>
  );
};
