  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <AppText variant="header" color={Colors.white} style={{flex: 1, marginLeft: s(12)}}>Cart</AppText>
        <TouchableOpacity>
        ...
        <View style={styles.storeCard}>
          <View style={styles.storeHeader}>
            <View style={styles.storeBadge}>
              <AppText variant="small" color={Colors.white}>MedPlus Mart</AppText>
            </View>
            <TouchableOpacity>
              <AppText variant="bodyBold" color={Colors.primary}>Add Items</AppText>
            </TouchableOpacity>
          </View>
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('MedicinePaymentSuccess')}>
          <AppText variant="bodyBold" color={Colors.white}>Proceed</AppText>
        </TouchableOpacity>
      </View>
    </View>
  );
