...
const TelemedicineProfileScreen = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTopRow}>
          ...
          <TouchableOpacity
            style={styles.backBtn}
            activeOpacity={0.7}>
            <Icon family="Ionicons" name="videocam-outline" size={20} color={Colors.white} />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.profileSection}>
          <View style={styles.avatarLarge}>
            {doctor?.image ? (
              <Image source={doctor.image} style={styles.avatarLargeImage} resizeMode="cover" />
            ) : (
      ...
      <ScrollView
        ...
        <View style={styles.videoInfoCard}>
          ...
          <AppText variant="body" color={Colors.tealText} style={{flex: 1, marginLeft: s(10)}}>
            Your video call will start at the booked time. Ensure a stable internet connection.
          </AppText>
        </View>
        ...
        <View style={styles.sectionTitleRow}>
          ...
          <AppText variant="header" style={{marginLeft: s(8)}}>Choose Appointment Slot</AppText>
        </View>
        ...
        <View style={styles.slotsHeaderRow}>
          <AppText variant="bodyBold">Available Appointment Slots</AppText>
        ...
        <View style={styles.feeCard}>
          <View style={{flex: 1}}>
            <AppText variant="bodyBold">Consultation Fee</AppText>
            <AppText variant="caption" color={Colors.textSecondary} style={{marginTop: vs(2)}}>Video Consultation</AppText>
          </View>
          <AppText variant="header" color={Colors.primary}>{'\u20B9'}499</AppText>
        </View>
      ...
      <View style={styles.bottomBar}>
        <TouchableOpacity
          ...
          onPress={handleBook}>
          <Icon family="Ionicons" name="videocam" size={20} color={Colors.white} style={{marginRight: s(8)}} />
          <AppText variant="bodyBold" color={Colors.white}>Book Video Consultation</AppText>
        </TouchableOpacity>
      </View>
    </View>
  );
...
export default TelemedicineProfileScreen;
