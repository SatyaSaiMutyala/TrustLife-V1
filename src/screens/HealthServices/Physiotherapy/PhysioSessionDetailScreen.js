...
const PhysioSessionDetailScreen = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={{flex: 1, marginLeft: s(12)}}>
          <AppText variant="header" color={Colors.white} numberOfLines={1}>{appointment?.physioName || 'Session Detail'}</AppText>
      ...
      <ScrollView
        ...
        <View style={styles.card}>
          <View style={styles.cardTitleRow}>
            ...
            <AppText variant="bodyBold" style={{marginLeft: s(8)}}>Therapist Details</AppText>
          </View>
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Name</AppText>
              <AppText variant="body">{appointment?.physioName || 'Dr. Arjun Mehta'}</AppText>
            </View>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Specialty</AppText>
              <AppText variant="body">{appointment?.specialty || 'Sports Physiotherapy'}</AppText>
            </View>
            <View style={styles.detailRow}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              ...
              <AppText variant="body">{appointment?.sessionType || 'Clinic Visit'}</AppText>
            </View>
            <View style={styles.detailRow}>
              ...
              <AppText variant="body" style={{flex: 1, textAlign: 'right'}} numberOfLines={2}>
                {appointment?.address || 'Clinic Visit'}
              </AppText>
            </View>
          </View>
        </View>
...
export default PhysioSessionDetailScreen;
