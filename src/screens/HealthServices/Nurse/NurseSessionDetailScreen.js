...
const NurseSessionDetailScreen = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={{flex: 1, marginLeft: s(12)}}>
          <AppText variant="header" color={Colors.white} numberOfLines={1}>{appointment?.nurseName || 'Session Detail'}</AppText>
      ...
      <ScrollView
        ...
        <View style={styles.card}>
          <View style={styles.cardTitleRow}>
            ...
            <AppText variant="bodyBold" style={{marginLeft: s(8)}}>Nurse Details</AppText>
          </View>
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Name</AppText>
              <AppText variant="body">{appointment?.nurseName || 'Sr. Meera Joshi'}</AppText>
            </View>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Specialty</AppText>
              <AppText variant="body">{appointment?.specialty || 'Pediatric Nurse'}</AppText>
            </View>
            <View style={styles.detailRow}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              ...
              <AppText variant="body">{appointment?.sessionType || 'Home Visit'}</AppText>
            </View>
            <View style={styles.detailRow}>
...
export default NurseSessionDetailScreen;
