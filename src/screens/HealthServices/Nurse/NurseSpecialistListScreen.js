...
const filterSections = [
  {key: 'specialization', label: 'Specialization', options: ['Pediatric Nurse', 'ICU Nurse', 'Oncology Nurse', 'Cardiac Nurse', 'Home Care Nurse', 'General Nurse'], multi: true},
...
const nurseImages = [
  require('../../../assets/img/nurse-six.png'),
  require('../../../assets/img/nurse-seven.png'),
  require('../../../assets/img/nurse-eight.png'),
];
...
const mockNurses = [
  {
    ...
    experience: '10 years',
    isOnline: true,
    consultationType: 'Home Visit & Video',
    fee: 600,
    image: nurseImages[0],
  },
  {
  ...
  {
    id: 'N006',
    name: 'Sr. Lakshmi Iyer',
    specialty: 'General Nurse',
    rating: 4.4,
    reviews: 51,
    experience: '3 years',
    isOnline: true,
...
const NurseSpecialistListScreen = () => {
  ...
  const nurses = mockNurses.map(n => ({...n, specialty: specialtyName || n.specialty}));
      ...
      <FlatList
        ...
        renderItem={({item}) => (
          <TouchableOpacity
            ...
            activeOpacity={0.7}
            onPress={() => navigation.navigate('NurseProfile', {nurse: item})}>
            {/* Online status dot */}
            ...
            <AppText variant="bodyBold" style={styles.nurseName} numberOfLines={1}>{item.name}</AppText>
...
export default NurseSpecialistListScreen;
