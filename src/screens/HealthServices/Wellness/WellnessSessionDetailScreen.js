...
const WellnessSessionDetailScreen = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={{flex: 1, marginLeft: s(12)}}>
          <AppText variant="header" color={Colors.white} numberOfLines={1}>
            {appointment?.centerName || 'Wellness Session'}
          </AppText>
      ...
      <ScrollView
        ...
        <View style={styles.idRow}>
          <View>
            ...
            <AppText variant="bodyBold">{appointment?.id || 'W001'}</AppText>
          </View>
        ...
        {/* Wellness Center Details */}
        <View style={styles.card}>
          <View style={styles.cardTitleRow}>
            <Icon family="Ionicons" name="business-outline" size={18} color={Colors.primary} />
            <AppText variant="bodyBold" style={{marginLeft: s(8)}}>Wellness Center Details</AppText>
          </View>
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Name</AppText>
              <AppText variant="body">{appointment?.centerName || 'Sushma Wellness Center'}</AppText>
            </View>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Location</AppText>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Icon family="Ionicons" name="location-outline" size={14} color={Colors.textSecondary} />
                <AppText variant="body" style={{marginLeft: s(3)}}>{appointment?.location || 'Madhapur'}</AppText>
              </View>
            </View>
            <View style={styles.detailRow}>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <AppText variant="body" style={{marginLeft: s(4)}}>{appointment?.rating || 4.5}</AppText>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.card}>
          <View style={styles.cardTitleRow}>
            ...
            <AppText variant="bodyBold" style={{marginLeft: s(8)}}>Service Details</AppText>
          </View>
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Service</AppText>
              <AppText variant="body">{appointment?.serviceName || 'Yoga'}</AppText>
            </View>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Duration</AppText>
              <AppText variant="body">{appointment?.duration || '60 min'}</AppText>
            </View>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Therapist</AppText>
              <AppText variant="body">{appointment?.therapistName || 'Dr. Meena Kapoor'}</AppText>
            </View>
          </View>
        </View>
        ...
        {isConfirmed && (
          <View style={styles.actionsSection}>
            <TouchableOpacity style={styles.directionBtn} activeOpacity={0.7}>
              ...
              <AppText variant="bodyBold" color={Colors.primary} style={{marginLeft: s(8)}}>Get Directions</AppText>
            </TouchableOpacity>
            <TouchableOpacity
              activeOpacity={0.7}
        ...
        {isCompleted && (
          <View style={styles.actionsSection}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              onPress={() => navigation.goBack()}>
              <AppText variant="bodyBold" color={Colors.white}>Book Again</AppText>
            </TouchableOpacity>
...
export default WellnessSessionDetailScreen;
