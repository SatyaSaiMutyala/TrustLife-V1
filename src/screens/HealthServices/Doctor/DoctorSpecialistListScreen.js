...
const filterSections = [
  {key: 'specialization', label: 'Specialization', options: ['Cardiologist', 'Neurologist', 'Dermatologist', 'Orthopedic', 'Pediatrician', 'ENT'], multi: true},
...
const DoctorSpecialistListScreen = () => {
        ...
        renderItem={({item}) => (
          <TouchableOpacity
            ...
            <View style={styles.specialtyBadge}>
              <AppText variant="small" color={Colors.tealText} style={{fontWeight: '600'}}>{item.specialty}</AppText>
            </View>
          </TouchableOpacity>
        )}
      />
...
export default DoctorSpecialistListScreen;
