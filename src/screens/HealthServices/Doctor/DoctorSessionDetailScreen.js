    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={{flex: 1, marginLeft: s(12)}}>
          <AppText variant="header" color={Colors.white} numberOfLines={1}>{appointment?.doctorName || 'Session Detail'}</AppText>
      ...
      <ScrollView
        ...
        <View style={styles.idRow}>
          <View>
            ...
            <AppText variant="bodyBold">{appointment?.id || 'APT001'}</AppText>
          </View>
        ...
        <View style={styles.card}>
          <View style={styles.cardTitleRow}>
            ...
            <AppText variant="bodyBold" style={{marginLeft: s(8)}}>Doctor Details</AppText>
          </View>
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Name</AppText>
              <AppText variant="body">{appointment?.doctorName || 'Dr. Priya Sharma'}</AppText>
            </View>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Specialty</AppText>
              <AppText variant="body">{appointment?.specialty || 'Cardiologist'}</AppText>
            </View>
            <View style={styles.detailRow}>
        ...
        <View style={styles.card}>
          <View style={styles.cardTitleRow}>
            ...
            <AppText variant="bodyBold" style={{marginLeft: s(8)}}>Consultation Details</AppText>
          </View>
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Type</AppText>
              <AppText variant="body">{appointment?.consultationType || 'Video Consultation'}</AppText>
            </View>
            <View style={styles.detailRow}>
        ...
        {isConfirmed && (
          <View style={styles.actionsSection}>
            ...
            <TouchableOpacity
              ...
              <AppText variant="bodyBold" color={Colors.red}>Cancel Appointment</AppText>
            </TouchableOpacity>
          </View>
        )}
        ...
        {isCompleted && (
          <View style={styles.actionsSection}>
            <TouchableOpacity style={styles.rescheduleBtn} activeOpacity={0.7}>
              <AppText variant="bodyBold" color={Colors.white}>Reschedule Appointment</AppText>
            </TouchableOpacity>

            {/* Feedback Section */}
            <View style={styles.feedbackCard}>
              <AppText variant="bodyBold" style={{marginBottom: vs(10)}}>Rate your consultation</AppText>
              ...
              {feedbackRating > 0 && (
                <AppText variant="caption" color={Colors.textSecondary} style={{marginTop: vs(8), textAlign: 'center'}}>
                  {feedbackRating <= 2 ? 'We will do better next time' : feedbackRating <= 3 ? 'Thank you for your feedback' : 'Glad you had a great consultation!'}
                </AppText>
              )}
            </View>
          </View>
      ...
      <Modal
        ...
        <TouchableOpacity
          ...
          <View style={styles.modalSheet} onStartShouldSetResponder={() => true}>
            ...
            <AppText variant="header" style={{marginBottom: vs(4)}}>Cancel Appointment</AppText>
            ...
            <TouchableOpacity
              ...
              <AppText variant="bodyBold" color={Colors.white}>Cancel Appointment</AppText>
            </TouchableOpacity>
          </View>
        </TouchableOpacity>
      </Modal>
...
export default DoctorSessionDetailScreen;
