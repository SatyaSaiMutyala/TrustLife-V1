...
const CounsellingSessionDetailScreen = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={{flex: 1, marginLeft: s(12)}}>
          <AppText variant="header" color={Colors.white} numberOfLines={1}>{appointment?.counsellorName || 'Session Detail'}</AppText>
      ...
      <ScrollView
        ...
        <View style={styles.idRow}>
          <View>
            ...
            <AppText variant="bodyBold">{appointment?.id || 'CS001'}</AppText>
          </View>
        ...
        <View style={styles.card}>
          <View style={styles.cardTitleRow}>
            ...
            <AppText variant="bodyBold" style={{marginLeft: s(8)}}>Counsellor Details</AppText>
          </View>
          <View style={styles.cardBody}>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Name</AppText>
              <AppText variant="body">{appointment?.counsellorName || 'Dr. Meera Joshi'}</AppText>
            </View>
            <View style={styles.detailRow}>
              <AppText variant="caption" color={Colors.textSecondary} style={styles.detailLabel}>Specialty</AppText>
              <AppText variant="body">{appointment?.specialty || 'Stress Counselling'}</AppText>
            </View>
            <View style={styles.detailRow}>
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <AppText variant="body" style={{marginLeft: s(4)}}>{appointment?.rating || 4.9}</AppText>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardBody}>
            ...
            <View style={styles.detailRow}>
              ...
              <AppText variant="body" style={{fontSize: ms(12)}}>{appointment?.transactionId || 'TXN20260325101'}</AppText>
            </View>
          </View>
        </View>
...
export default CounsellingSessionDetailScreen;
