...
const filterSections = [
  {key: 'specialization', label: 'Specialization', options: ['Stress Counselling', 'Anxiety Counselling', 'Relationship Counselling', 'Lifestyle Counselling', 'Mental Health', 'Family Counselling'], multi: true},
...
const counsellorImages = [
  require('../../../assets/img/counselling-six.png'),
  require('../../../assets/img/counselling-seven.png'),
  require('../../../assets/img/counselling-eight.png'),
];
...
const CounsellingSpecialistListScreen = () => {
  ...
  const counsellors = mockCounsellors.map((c, index) => ({
    ...c,
    specialty: specialtyName || 'Stress Counselling',
    image: counsellorImages[index % counsellorImages.length],
  }));
      ...
      <FlatList
        ...
        renderItem={({item}) => (
          <TouchableOpacity
            ...
            activeOpacity={0.7}
            onPress={() => navigation.navigate('CounsellingProfile', {counsellor: item})}>
            {/* Online status dot */}
            ...
            <AppText variant="bodyBold" style={styles.counsellorName} numberOfLines={1}>{item.name}</AppText>
...
export default CounsellingSpecialistListScreen;
